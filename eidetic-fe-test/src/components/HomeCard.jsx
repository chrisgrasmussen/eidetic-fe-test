                ...
                <div className="">
                    <div className="w-[900px] bg-sky-100 rounded-xl shadow-2xl">
                        <div className="">
                            ...
                            <h3 className="text-3xl text-gray-600 font-regular py-10">
                                {randomStart.title}
                            </h3>
                        ...
                        <div className="px-6 py-4">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex items-center py-2 px-3">
                                    <button type="button" onClick={handleClick} className="justify-center p-2 text-gray-500 rounded-full cursor-pointer hover:text-gray-900 bg-indigo-500 ">
                                        <svg fill="#ffffff" width="25px" height="25px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M 23 3 L 23 7 L 18.40625 7 L 18.125 7.5 L 14.5 13.96875 L 10.59375 7 L 4 7 L 4 9 L 9.40625 9 L 13.34375 16 L 9.40625 23 L 4 23 L 4 25 L 10.59375 25 L 19.59375 9 L 23 9 L 23 13 L 28 8 Z M 16.78125 18 L 15.625 20.0625 L 18.40625 25 L 23 25 L 23 29 L 28 24 L 23 19 L 23 23 L 19.59375 23 Z"></path></g></svg>
                                    </button>

                                    <textarea onChange={handleChange} name="completeText" rows="5" className="block mx-4 p-2.5 w-full text-2xl text-gray-700 bg-white rounded-lg border border-gray-600 focus:ring-blue-500 focus:border-blue-500  " placeholder="Complete your thought.."></textarea>
